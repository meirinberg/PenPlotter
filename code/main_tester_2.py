...
def File_Draw():
    ...
    """
    motor_radial = StepperMotor(1, 0b00001000, 1000, 1500)
    motor_radial.setPositionMode()
    motor_radial.setXActualToZero()
    
    motor_theta = StepperMotor(2, 0b00000001, 1000, 1023)
    motor_theta.setPositionMode()
...
def Free_Draw():
    ...
    """
    motor_radial1 = StepperMotor(1, 0b00001000, 1023, 1023)
    motor_radial1.setVelocityMode()
    
    motor_theta1 = StepperMotor(2, 0b00000001, 1000, 1023)
    motor_theta1.setVelocityMode()
    
    motor_radial1.setVelocity(3000,5000)
    motor_theta1.setVelocity(3000,5000)
    ...
    while True:
        ...
        if state.get() == 4:
           ...
           if abs(radial_speed) > 200:
               targetY = motor_radial1.convertIntToBytes(radial_speed)    
           else:
               radial_speed = 0
               targetY = motor_radial1.convertIntToBytes(0)
          
           if abs(theta_speed) > 200:
               targetX = motor_theta1.convertIntToBytes(theta_speed)   
           else:
               theta_speed = 0
               targetX = motor_theta1.convertIntToBytes(0)
          

           radialTargetByteSet = bytearray([motor_radial1.VTARGET_ADDR, 
                                      targetY[0],
                                      targetY[1],
                                      targetY[2]])
          
           thetaTargetByteSet = bytearray([motor_theta1.VTARGET_ADDR, 
                                      targetX[0],
                                      targetX[1],
                                      targetX[2]]) 
           ...
           motor_radial1.sendByteSet(radialTargetByteSet)
           motor_theta1.sendByteSet(thetaTargetByteSet)
...
#        MODE_ADDR =             0b01110010
       ...
       testByteSet = bytearray([TYPE_VER_ADDR,
                                   0b00000000,
                                   0b00000000,
                                   0b00000000])
       ...
       pulseAndRampDivByteSet = bytearray([PULSE_RAMP_ADDR,
                                              0b00000000,
                                              0b01110111, # 0b01110111 for microsteps
                                              0b00000000]) 

           
       vrampModeByteSet = bytearray([MODE_ADDR,
                                        0b00000000,
                                        0b00000000,
                                        0b00000010])
           
       xrampModeByteSet = bytearray([MODE_ADDR,
                                        0b00000000,
                                        0b00000000,
                                        0b00000000])
           
       xTargetByteSet = bytearray([XTARGET_ADDR,
                                      0b00000000,
                                      0b00000000,
                                      0b10011011])
    
       zeroTarget = bytearray([XTARGET_ADDR,
                                  0b00000000,
                                  0b00000000,
                                  0b00000000]) 
           
       vTargetByteSet = bytearray([VTARGET_ADDR, 
                                      0b00000000,
                                      0b00000000,
                                      0b00000000]) 
           
       limitswitches = bytearray([LIMIT_SWITCHES_ADDR, 
                                     0b00000000,
                                     0b00000011,
                                     0b00010000])
       ...
       enableByteSet = bytearray([ENABLE_ADDR,
                                     0b00000000,
                                     0b00000000,
                                     0b00100000])
       ...
       pmul = 0
       pdiv = 0
       aMaxByteSet = bytearray([0,0,0,0])
       calculated_Pdiv = bytearray([0,0,0,0])
       ...
       def __init__(self, chipSelect, acceleration, vMin, vMax):
          ...
          self.aMaxByteSet = bytearray([self.AMAX_ADDR,
                                   0b00000000,
                                   0b00000000,
                                   self.accelerationValue]) 
          
          self.pmul, self.pdiv = self.set_accel(self.accelerationValue)
           
          self.calculated_Pdiv = bytearray([self.PMUL_PDIV_ADDR,
                                       0b00000000,
                                       self.pmul,
                                       self.pdiv & 0b00001111])
          # Send the byte sets:
...
#            return currentPosition == position
       ...
       def setVelocityMode(self):
          self.sendByteSet(self.enableByteSet)
          self.setVelocity(self.vMin,self.vMax)
          self.sendByteSet(self.pulseAndRampDivByteSet)
          self.sendByteSet(self.aMaxByteSet)
          self.sendByteSet(self.calculated_Pdiv)
          self.sendByteSet(self.vrampModeByteSet)
          self.sendByteSet(self.vTargetByteSet)
          print(self.sendByteSet(self.readModeByteSet))
       ...
       def setPositionMode(self):
          ...
          self.sendByteSet(self.aMaxByteSet)
          self.sendByteSet(self.calculated_Pdiv)
          self.sendByteSet(self.xrampModeByteSet)
